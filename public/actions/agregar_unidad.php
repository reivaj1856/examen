...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    $stmt = $pdo->prepare("INSERT INTO Unidad (nombre_area) VALUES (:nombre_area)");
    $stmt->execute([':nombre_area' => $_POST['nombre_area']]);
...
<html lang="es">
<head>
  <meta charset="UTF-8"><title>Agregar Unidad</title>
  <style>
...
<div class="form-box">
  ...
  <form method="POST">
    <label>Nombre:</label>
    <input name="nombre_area" required>
