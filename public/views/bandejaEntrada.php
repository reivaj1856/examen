...
// Solo documentos cuyo ultimo destinatario sea el usuario logueado
$stmt = $pdo->prepare(
...
<div class="p-6 mx-auto max-w-7xl">
	...
	<div class="p-6 bg-gray-50 mx-auto mb-8 border bg-gray-100 rounded-sm max-w-3xl">
		...
		<p class="text-xs text-gray-500 mt-3">Mostrando solo documentos asignados al usuario logueado como ultimo derivado.</p>
	</div>
